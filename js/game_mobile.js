...
document.getElementById("leftBtn").addEventListener("touchstart", () => {
  if (ninja.x > 0) ninja.x -= ninja.speed * 2;
});
document.getElementById("rightBtn").addEventListener("touchstart", () => {
  if (ninja.x < canvas.width - ninja.width) ninja.x += ninja.speed * 2;
});
document.getElementById("fireBtn").addEventListener("touchstart", fireShuriken);
